...
namespace OrderApi.Data.Database
{
    public class OrderContext : DbContext
    {
            ...
            : base(options)
        {
            ...
            // commented for use SQL server database
            //var orders = new[]
            //{
            //    new Order
            //    {
            ...
            //        OrderState = 1,
            //        CustomerId = Guid.Parse("d3e3137e-ccc9-488c-9e89-50ba354738c2"),
            ...
            //        OrderState = 1,
            //        CustomerId = Guid.Parse("4a2f1e35-f527-4136-8b12-138a57e1ba08"),
            ...
            //        OrderState = 2,
            //        CustomerId = Guid.Parse("334feb16-d7bb-4ca9-ab56-f4fadeb88d21"),
